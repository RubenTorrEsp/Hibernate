...
public class ConsultaEjercicio6 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Query query = miSession.createQuery("FROM Pedidos p INNER JOIN p.empleados WHERE p.clientes.codigo = 'Anton'");
	
			//Lista de objetos donde se guardará el resultado de la consulta anterior
			List<Object[]> lista = query.list();
			
			//Cabecera mostrada por pantalla
			System.out.println("\nEjercicio 6.- Los pedidos que hizo la empleada Nancy\n");
